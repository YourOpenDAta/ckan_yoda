...
# Overwrites production.ini file configuration (defined in CONFIG_FROM_ENV_VARS in CKAN code) 
# Consequently: The resulting values in production.ini file (of the following environment varialbles) will not take effect for CKAN, 
# the environment variables are the ones that take effect.
set_environment () {
